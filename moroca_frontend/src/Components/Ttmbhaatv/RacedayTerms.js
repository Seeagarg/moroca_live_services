  ...
  return (
    <div className='text-font text-gray-700 mx-5' >
      ...
      <div className='bg-white rounded-lg shadow-lg  px-7 mx-auto border container mt-10  md:mx-auto  scrollable-content '>
        ...
        <p className='mt-5 text-gray-700'><b className='text-black'>NOTICE:</b> The Racedaytv.co.za service is provided subject to these terms and conditions which explain how you may access and use the service and the Privacy Policy.</p>
        ...
        <h1><u>RACEDAY TV CONTENT AND PRICING</u></h1>


        <p className='mt-3'>Racedaytv.co.za is a mobile subscription service charged at R3 per day which offers you unlimited access of the content available while you remain subscribed (the “Service”). The daily charge will be recovered directly from your network service provider and you will in turn pay your network service provider. You authorize us to recover the relevant amounts directly from your network service provider who you authorize to pay us. You confirm that you are allowed to provide the authorizations mentioned above. Network charges may also apply.</p>
        <p className='mt-3'>Racedaytv.co.za has some of the most trending mobile content available plus an extensive amount of new content and categories added on a regular basis (the “Content”). Being a member of Racedaytv.co.za gives you access to this wide and varied selection of mobile content.</p>
        ...
        <p className='mt-4'>CLICK the unsubscribe button at the bottom of the Racedaytv.co.za homepage.</p>

        <h1 className='mt-5'><u>INTRODUCTION</u></h1>
        <p className='mt-4'>The Service is operated by Bubble Bobble, which is a limited liability company registered in the Republic of South Africa under company number 2018/287015/07, trading here as ‘Racedaytv.co.za’ (the “Company“, “we”, “us”, “our”).</p>
        ...
        <p className='mt-5'>2.2 You agree to abide in full with this Agreement.</p>
         <p className='mt-5'>2.3 You may only access the Content and/or use the Service by accessing: http://www.Racedaytv.co.za/ (the “Website”). You are not allowed to access the Service through any other medium.</p>
