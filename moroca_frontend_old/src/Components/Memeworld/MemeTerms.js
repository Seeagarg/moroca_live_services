...
const MemeTerms = () => {
  ...
  return (
    <>
       <button onClick={() => window.history.back()}  className=' text-black font-bold mt-5 px-4 py-2 '>Go Back</button>

    {/* <MemeNav/> */}
        <div className='container  px-5 md:mx-auto bg-white'>
     <h1 className='text-gray-700 font-bold text-xl font-family text-center mb-4  '> Terms and Conditions</h1>
     <hr></hr>
      <p  className='mt-4'><b className='text-gray-700'>MEME WORLD:</b> TERMS AND CONDITIONS.</p>
<p>
SUBSCRIPTION SERVICE: 18+ ONLY. R3/DAY
</p>
<p className='mt-5'><b className='text-gray-700 '>NOTICE:</b>
 The memeworld.co.za service is provided subject to these terms and conditions which explain how you may access and use the service and the Privacy Policy.
</p>

<p className='mt-5'>
IF YOU ARE UNDER 18 OR DO NOT CONSENT TO THIS AGREEMENT OR IF YOU ARE NOT WILLING TO BE BOUND BY IT THEN DO NOT ACCESS THE SERVICE OR PROMPTLY CEASE USING THE SERVICE ON YOUR DEVICE.
</p>


<h1 className='mt-5'><u>MEME WORLD CONTENT AND PRICING</u></h1>
<p className='mt-5'>
memeworld.co.za is a mobile subscription service charged at R3 per day which offers you unlimited access of the content available while you remain subscribed (the “Service”). The daily charge will be recovered directly from your network service provider and you will in turn pay your network service provider. You authorize us to recover the relevant amounts directly from your network service provider who you authorize to pay us. You confirm that you are allowed to provide the authorizations mentioned above. Network charges may also apply.
</p>

<p className='mt-5'> 
memeworld.co.za has some of the most trending mobile content available plus an extensive amount of new content and categories added on a regular basis (the “Content”). Being a member of memeworld.co.za gives you access to this wide and varied selection of mobile content.
</p>

<h1 className='mt-5'><u>MARKETING COMMUNICATIONS</u></h1>
...
<h1 className='mt-5'><u>CANCELLATION</u></h1>
...
<p className='mt-5'>
CLICK the unsubscribe button at the bottom of the memeworld.co.za homepage.
</p>

<h1 className='mt-5'><u>INTRODUCTION</u>

</h1>

<p className='mt-5'>
The Service is operated by Bubble Bobble, which is a limited liability company registered in the Republic of South Africa under company number 2018/287015/07, trading here as ‘memeworld.co.za’ (the “Company“, “we”, “us”, “our”).

</p>
<p className='mt-5'>
The Service is billed by Company’s collections agency. Bubble Bobble is bound by the WASPA Code of Conduct. You have the right to approach WASPA to lodge a complaint in accordance with the WASPA complaints procedure. Bubble Bobble may be required to share information relating to a service or a customer with WASPA for the purpose of resolving a complaint. WASPA web site: www.waspa.org.za
</p>

<h1 className='mt-5'><u>EFFECT OF THIS AGREEMENT</u>
</h1>
<p className='mt-5'>
...
<h1 className='mt-5'><u>YOUR REPRESENTATIONS</u>
...
<ul className='px-3'>
  <li className='py-1'>a) are located in South Africa;</li>
  <li>
...
<li className='py-1'>
g) are the authorized owner of the device which you registered to the Service during the registration process or any subsequent device registered on the Service.
</li>
</ul>
...
<p className='mt-5'>
3.3 You may only access the Content and/or use the Service by accessing: <span className='text-red-600 font-bold'>http://www.memeworld.co.za/</span> (the “Website”). You are not allowed to access the Service through any other medium.
</p>
...
<h1 className='mt-5'><u>REGISTRATION</u>
...
9.1 Should you wish to make a complaint to us in respect of the Service or other matter, please contact us via telephone on 011 083 7966 or by emailing help@bubblebobble.co.za. We will endeavor to assist you as soon as reasonably possible.
</p>

<p className='mt-5'>
9.2 The Company is bound by the WASPA Code of Conduct. Customers have the right to approach WASPA to lodge a complaint in accordance with the WASPA complaints procedure. The Company may be required to share information relating to the Service or a customer with WASPA for the purpose of resolving a complaint. WASPA website: www.waspa.org.za
...
10.1 The following provisions set out the entire financial liability of the Company (including any liability for acts or omissions of its parent company, subsidiaries, associated companies, employees, agents and sub-contractors) to you in respect of: a) any breach of this Agreement, including any deliberate personal repudiatory breach or any deliberate breach of these conditions by a party, or its employees, agents or subcontractors; and b) any representation, statement and/or tortuous act or omission including negligence arising under or in connection with the Service.
</p>
<p className='mt-5'>
...
<h1><u>GOVERNING LAW AND DISPUTES</u></h1>
...
Customer Services: Bubble Bobble
</p>
<p className='mt-3'>

Helpline: 011-083-7966
</p>
<p className='mt-3 '>

Email: help@bubblebobble.co.za
</p>
<p className='mt-3 mb-3'>

CLICK the unsubscribe button at the bottom of the memeworld.co.za homepage to unsubscribe anytime.
</p>
    </div>
    </>
