...
import ttbanner from '../../assets/TTMBHATV_files/ttbhatv.png'
import '../../css/Login.css';
import { toast } from 'react-toastify';

const TTLogin = ({ service_id, serviceName }) => {
  console.log("serviceid aservice", serviceName, service_id)
  ...
  return (
    <div style={{
      ...
      <div className='md:mx-[120px] w-full md:w-auto bg-[#E16463] flex justify-center px-4 '>
        <form onSubmit={redirectUser} className='max-w-lg rounded-md' style={{ width: '100%', padding: '20px' }}>
          <h1 className='text-white text-2xl md:text-4xl mt-5'>Welcome To <span className='text-white font-bold'>TTMBHATV</span></h1>
